...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'university.Entities.Students.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('university.Entities.Students.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../services/v4/js/university/api/Entities/Students.js';
